...
var vineyard_cron_1 = require("vineyard-cron");
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var village, model;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, lab_1.createEthereumVillage(config_1.ethereumConfig)];
                case 1:
                    village = _a.sent();
                    console.log('Initialized village');
                    model = village.model;
                    return [4 /*yield*/, (model.ground).regenerate()];
                case 2:
                    _a.sent();
...
var ethereumCron = new vineyard_cron_1.Cron([
    {
        name: 'Ethereum Scanner',
        action: function () { return main(); }
    }

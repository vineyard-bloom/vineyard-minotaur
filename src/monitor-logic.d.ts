...
import { BlockQueue, BlockQueueConfig } from "./block-queue";
...
export declare function mapBlocks<Block extends IndexedHashedBlock, Transaction>(fullBlocks: blockchain.BlockBundle<Block, Transaction>[]): (s: IndexedHashedBlock) => blockchain.BlockBundle<Block, Transaction>;
